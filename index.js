...
family = {'married':1983, 'presidentOfTheUnitedStates':false, 'children':['John David', 'Katia', 'Olivia', 'Malcolm']};
...
const earlywork = {'Carbon Copy':1981, 'A Soldier Story':1984, 'Power':1986, 'Cry Freedom':1987, 'For Queen and Coutryy':1988};
...
const debatersBig = debaters.toUpperCase();
// Q8. Using this array.
...
function duplicate(arrayString){
  const result = arrayString;
  arrayString.forEach(element => result.push(element));
  return result;
}
...
websites =  ['coursera.org', 'irrationallabs.com', 'iim.fr']; 
// Q17. Describe an ESILV project that you worked on that you’re proud of?
const proud = 'I took part in a project in partnership with Miscrosoft with the aim of helping dyslexic people. Fascinating, difficult, engaging.';
// Q18. Describe an ESILV project that you worked on that you’re not so proud of?
const proudNot = 'A project where we had to build some small robot. We tried a way different than most and the result were disappointing. We were in the last quarter';
